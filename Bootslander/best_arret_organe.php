...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      if($_SESSION['datedebut'] == '2023-01-27'){
        header("Location:./best_arret_organe.php");
    }else{
      header("Location:./best_arret_organe.php");
    }
  }
...
<img style="margin-top:-650px; margin-left:2100px;" src="assets/img/soboa-icones.png" alt="Imperial" width=80; height=80;>
   ...
   <div class="col-md-12 col-xs-12 spacer   "style="margin-top:-300px;  ">
    	  <div class="panel panel-info spacer ">
            ...
            <div class="panel-body" style= "margin-left: px;">
              ...
              <div class="col-md-3 col-xs-2 spacer   ">
    	  .       <div class="panel panel-info spacer ">
                      ...
                      <form method="post" id="regForm">
                           ...
                           <button type="submit" name="submit" class="btn btn-success" style="font-size:30px; font-family: cursive; font-weight: bold;">ValiderDate</button>
                        </form>
                              </br>
                        <form method="post" action="../T_best_arret_organe.php">
                              <div class="field">
                           ...
                           <button type="submit" name="bestarretorgane" class="btn btn-success" style="font-size:30px; font-family: cursive; font-weight: bold;">ValiderSommeArrêtByorgane</button>
                        </form>
                        </br>
                        <form method="post" action="../T_best_freq_arret_organe.php">
                              <div class="field">
                              <input  class="field-input" type="hidden" name="datedebut" id="date" value="<?php print(date( $_SESSION['datedebut'])); ?>"/>
                              </div>
                            ...
                            <button type="submit" name="bestarretorgane" class="btn btn-success"style="font-size:30px; font-family: cursive; font-weight: bold;">ValiderFréquenceArrêtByOrgane</button>
                        </form>
                        </br>
              ...
              <div class="field bn  ">
                <?php
                   echo "<img  src='../T_best_arret_organe.php'/>";?>
              </div>
              </br>
              <div class="field bn flotte">
                <?php
                   echo "<img src='../T_best_freq_arret_organe.php'/>";?>
              </div>
