...
$query="SELECT * FROM quard2_g1cqprod";
$res=mysqli_query($a,$query);
$vales=[];
while($et=mysqli_fetch_assoc($res)) { 
	array_push($vales, $et["quard2"]);
}

$query1="SELECT * FROM quard2_g1ctmarret";
$res1=mysqli_query($a,$query1);
$vales1=[];
while($et1=mysqli_fetch_assoc($res1)) { 
	array_push($vales1, $et1["quard2"]);
}

$query2="SELECT * FROM quard2_g1ctarret";
$res2=mysqli_query($a,$query2);
$vales2=[];
while($et2=mysqli_fetch_assoc($res2)) { 
	array_push($vales2, $et2["quard2"]);
}

$query3="SELECT * FROM quard2_g1cnarret";
$res3=mysqli_query($a,$query3);
$vales3=[];
while($et3=mysqli_fetch_assoc($res3)) { 
	array_push($vales3, $et3["quard2"]);
}

$query4="SELECT * FROM quard2_g1ctprod";
$res4=mysqli_query($a,$query4);
$vales4=[];
while($et4=mysqli_fetch_assoc($res4)) { 
	array_push($vales4, $et4["quard2"]);
}

$query5="SELECT * FROM quard2_g1ctrg";
$res5=mysqli_query($a,$query5);
$vales5=[];
while($et5=mysqli_fetch_assoc($res5)) { 
	array_push($vales5, $et5["quard2"]);
}
...
$b6plot->SetWidth(45);
$graph->title->Set("Analyse des données du Quard 2 : ");
