   ...
   <div class="col-md-12 col-xs-12 spacer   "style="margin-top:-300px; margin-left:; ">
    	  ...
    	  .       <div class="panel panel-info spacer ">
                      ...
                      <form method="post" id="regForm">
                        ...
                        <form method="post" action="../T_best_arret_machine.php">
                              <div class="field">
                           ...
                           <button type="submit" name="bestarretmachine" class="btn btn-success" style="font-size:30px;font-family: cursive; font-weight: bold;">SommeArrêtByMachine</button>
                        </form>
                        
                        </br>
                        <form method="post" action="../T_best_freq_arret_machine.php">
                              <div class="field">
                              <input  class="field-input" type="hidden" name="datedebut" id="date" value="<?php print(date( $_SESSION['datedebut'])); ?>"/>
                              </div>
                            ...
                            <button type="submit" name="bestarretmachine" class="btn btn-success"style="font-size:30px;font-family: cursive; font-weight: bold;">FréquenceArrêtByMachine</button>
              ...
              <div class="field bn  ">
                <?php
                   echo "<img  src='../T_best_arret_machine.php'/>";?>
              </div>
              </br>
              <div class="field bn flotte" >
                <?php
                   echo "<img src='../T_best_freq_arret_machine.php' />";?>
              </div>
