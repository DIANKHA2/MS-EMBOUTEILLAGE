...
$query="SELECT * FROM analyse_recette_encours_g1";
$res=mysqli_query($a,$query);
$vales=[];
while($et=mysqli_fetch_assoc($res)) { 
	array_push($vales, $et["CompteurSoutireuse"]);
}

// Create the graph. These two calls are always required
$graph = new Graph(156,30,'auto');
...
$b1plot->SetWeight(0);
$b1plot->SetFillGradient("#800000","#800000",GRAD_HOR);
$b1plot->SetWidth(50);
