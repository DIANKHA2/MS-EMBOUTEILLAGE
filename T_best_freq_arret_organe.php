...
{ $dateFin=$_POST['datefin'];
 ...
 $stmt  = $db->prepare("CALL  getbestfreqArretByOrgane(:d,:f)");
...
$b1plot->SetShadow();
 ...
 $graph->title->Set("La fréquence des arrêts par organe");
 $graph->title->SetFont(FF_GEORGIA,FS_BOLD, 20);
 $graph->xaxis->title->Set("Top 6 des organes qui posent probléme");
