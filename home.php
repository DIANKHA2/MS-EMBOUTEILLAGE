...
<head>
  ...
  <!-- Favicons -->
  <link href="Bootslander/assets/img/soboa-icones.png" rel="icon">
  <link href="Bootslander/assets/img/soboa-icones.png" rel="apple-touch-icon">
...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="#"><span>MES EMBOUTEILLAGES</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="Bootslander/Affichage.php">plateforme de connexion</a></li>
      ...
      <div class="row">
        <div class="col-lg-7 pt-5 pt-lg-0 order-2 order-lg-1 d-flex align-items-center">
          <div data-aos="zoom-out">
            <div class="hero-logo">
          <img class="la" src="Bootslander/assets/img/soboa-icones.png" alt="Imperial">
        </div>
           
          </div>
        </div>
        <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="300">
          <img src="Bootslander/assets/img/hro-img.jpg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
          ...
          <div class="col-lg-4" data-aos="fade-right" data-aos-delay="100">
            <div class="info">
              <div class="address">
                ...
                <h4>Localisation:</h4>
                <p>Bel-Air. BP 290 CP 18524 Dakar , Senegal</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>sobo.contact@castel-afrique.com</p>
              </div>

              <div class="phone">
                <i class="icofont-phone"></i>
                <h4>Call:</h4>
                <p>+221 33 859 28 38</p>
              </div>
